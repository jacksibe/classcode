...
define('text!modules/home.html', ['module'], function(module) { module.exports = "<template><div class=\"topnav\" id=\"myTopnav\"><a class=\"active\" href=\"#home\">${message}</a></div>        <compose show.bind=\"showLogin\" view=\"./components/login.html\"></compose>    <compose show.bind=\"!showLogin\" view=\"./components/register.html\"></compose></template>"; });
...
define('text!modules/list.html', ['module'], function(module) { module.exports = "<template><div class=\"topnav\" id=\"myTopnav\"><a class=\"active\" href=\"#home\">${message}</a></div>         <compose show.bind=\"showList\" view=\"./components/todoList.html\"></compose>    <compose show.bind=\"!showList\" view=\"./components/todoForm.html\"></compose></template>"; });
